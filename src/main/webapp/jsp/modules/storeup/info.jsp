...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看收藏表</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看收藏表</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="inteltype" name="inteltype" class="form-control" v-model="ruleForm.inteltype" readonly>
				</div>
				<div class="form-item">
					<label>备注</label>
