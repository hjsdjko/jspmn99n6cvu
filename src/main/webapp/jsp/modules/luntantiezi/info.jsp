...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">查看论坛帖子</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>查看论坛帖子</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					...
					<input id="dongmanzhuti" name="dongmanzhuti" class="form-control" v-model="ruleForm.dongmanzhuti" readonly>
				</div>
				<div class="form-item">
					<label>帖子分类</label>

					<input id="tiezifenlei" name="tiezifenlei" class="form-control" v-model="ruleForm.tiezifenlei" readonly>
				</div>
