...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑视频分类</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>视频分类管理</span></li>
				<li class="breadcrumb-item-two"><span>编辑视频分类</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>视频分类</label>
					<input name="shipinfenlei" id="shipinfenlei" name="shipinfenlei" class="form-control" placeholder="请输入视频分类">
				</div>
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shipinfenlei != null && res.data.shipinfenlei != ''){
						...
						$("#shipinfenlei").attr('readonly','readonly');
					}
				}
			});  
            }
