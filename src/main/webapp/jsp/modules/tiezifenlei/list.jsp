...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">帖子分类管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>帖子分类管理</span></li>
				<li class="breadcrumb-item-two"><span>帖子分类列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>帖子分类</label>
					<input type="text" id="tiezifenleiSearch" class="form-control form-control-sm" placeholder="请输入帖子分类" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#tiezifenleiSearch').val() != null && $('#tiezifenleiSearch').val() != ''){
				searchForm.tiezifenlei ="%" +  $('#tiezifenleiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("tiezifenlei/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				tiezifenlei : searchForm.tiezifenlei,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tiezifenlei/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"tiezifenlei");
