...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">编辑帖子分类</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-two"><span>编辑帖子分类</span></li>
			</ol>
		</div>
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>帖子分类</label>
					<input name="tiezifenlei" id="tiezifenlei" name="tiezifenlei" class="form-control" placeholder="请输入帖子分类">
				</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "tiezifenlei/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("tiezifenlei/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("tiezifenlei/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("tiezifenlei/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#tiezifenlei").val(ruleForm.tiezifenlei);	
		}		
		//图片显示
		function showImg(){
		}		
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tiezifenlei != null && res.data.tiezifenlei != ''){
						...
						$("#tiezifenlei").val(res.data.tiezifenlei);
						$("#tiezifenlei").attr('readonly','readonly');
					}
				}
			});  
            }
